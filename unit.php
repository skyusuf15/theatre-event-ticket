...
<head>
    ...
    <title>Unit | National Theatre</title>
                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="formview">
                                    <br/>
                                    <form class="form-view other-page" id="unit">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="role">Unit Code<span class="important-field">*</span></label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" placeholder="Unit code" id="code">
                                                    </div>
                                                </div>                                        
                                            </div>
                                            <div class="col-md-6">
                                                <label for="role">Unit Name<span class="important-field">*</span></label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" placeholder="Unit Name" id="name">
                                                    </div>
                                                </div>                                        
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="level">Total Per Unit<span class="important-field">*</span></label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="number" min="1" class="form-control" placeholder="Quantiy" id="qty">
                                                    </div>
                                                </div>                                       
                                            </div> 
                                            <div class="col-md-6">
